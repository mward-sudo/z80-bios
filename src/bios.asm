...
start:
    ...
    ld hl, 0x4000   ; Start of screen memory
    ld b, 62        ; Number of characters (0-9, A-Z, a-z)
    ld a, 48        ; ASCII code for '0'
...
print_char:
    ...
    push de
    push hl
    sub 48          ; Adjust ASCII value to match our character set (0 = 0)
    jp m, char_done ; If it's below '0', don't print anything
    cp 62
